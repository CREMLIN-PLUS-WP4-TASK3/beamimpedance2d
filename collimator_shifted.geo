...
Point(1) = {px, py, 0, lfine};

Point(2) = {px+a-eps, py, 0, lveryfine};
Point(3) = {px+a,py, 0, lveryfine};
Point(4) = {px+a+eps,py, 0, 1.0*lveryfine};


Point(12) = {px+0,py+a-eps, 0, lveryfine};
Point(13) = {px+0,py+a,0,  lveryfine};
Point(14) = {px+0,py+a+eps, 0, 1.0*lveryfine};


Point(22) = {px-(a-eps), py, 0, lveryfine};
Point(23) = {px-a,py, 0, lveryfine};
Point(24) = {px-(a+eps),py, 0, 1.0*lveryfine};


Point(32) = {px+0,py-(a-eps), 0, lveryfine};
Point(33) = {px+0,py-a,0,  lveryfine};
Point(34) = {px+0,py-(a+eps), 0, 1.0*lveryfine};
