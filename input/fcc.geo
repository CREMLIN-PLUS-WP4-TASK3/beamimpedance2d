...
//Grounding
Point(401) = {h*Cos(phi),h*Sin(phi), 0, lvac};
Point(402) = {rx2*Cos(phi),rx2*Sin(phi), 0, lpipe};
...
Point(63) = {-xhole2,yhole2,0,lsing/3};
Point(64) = {-xhole2,-yhole2,0,lsing/3};
...
Line Loop(301) = {-119,-112,-113,410,999,411,111,-500,118,114,-116,-104,-101,103,102,-105,117,115};
...
Line Loop(302) = {201,202,203,204,999};  

// cooling
Point(101) = {-0.017,0,0,lsing/3};
...
Line Loop(303) = {300,301,305,306,307,302,310,308,309,303,304}; //cooling
...
// vacuum
Line Loop(304)={-102,-103,101,104,116,-114,-118,-305,-301,-300,-304,-303,-309,119,-115,-117,105};  //inner vac
Line Loop(305)={-112,-113,410, -204, -203 ,-202, -201, 411,-500,111,306,307,302,310,308};  //outer vac
Plane Surface(14)={304,103,113,123,133};              //inner vac
Plane Surface(15)={305};				//outer vac
