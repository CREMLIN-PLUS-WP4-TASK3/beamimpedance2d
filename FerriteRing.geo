...
Line Loop(32)={31,32,33,34};
Plane Surface(3) = {32,31,30};



//The outside vacuum
Point(31) = {h2,0, 0, lvac};
...
Physical Surface(2) = {2,4};   //vacuum
Physical Surface(5) = {3};   //Ferrite
