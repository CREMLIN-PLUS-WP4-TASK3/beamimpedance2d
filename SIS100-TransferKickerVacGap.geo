...
KHH=0.10;    // Kicker Half Height
KHW=0.115;  // Kicker Half Width
HG=0.0014;    // Half Gap
...
Point(202)={KHW,KHH,0,lfine};
Point(203)={-KHW,KHH,0,lfine};
...
Point(302)={KHW,-KHH,0,lfine};
Point(303)={-KHW,-KHH,0,lfine};
...
Physical Surface(2) = {1,4,7,10,13,14,17,18};   //vacuum
